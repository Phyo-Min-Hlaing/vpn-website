...
const plansData = [
  { id: 'basic-1m', name: 'Basic 1M', duration: '1 Month', durationDays: 30, price: '9.99', discount: '0', active: true, features: ['5 Devices', 'Standard Speed', 'Email Support'] },
  { id: 'basic-6m', name: 'Basic 6M', duration: '6 Months', durationDays: 180, price: '49.99', discount: '15', active: true, features: ['5 Devices', 'Standard Speed', 'Email Support'] },
  { id: 'basic-1y', name: 'Basic 1Y', duration: '1 Year', durationDays: 365, price: '89.99', discount: '25', active: true, features: ['5 Devices', 'Standard Speed', 'Email Support'] },
  { id: 'premium-1m', name: 'Premium 1M', duration: '1 Month', durationDays: 30, price: '14.99', discount: '0', active: true, features: ['10 Devices', 'High Speed', 'Priority Support', 'Ad Blocker'] },
  { id: 'premium-6m', name: 'Premium 6M', duration: '6 Months', durationDays: 180, price: '74.99', discount: '15', active: true, features: ['10 Devices', 'High Speed', 'Priority Support', 'Ad Blocker'] },
  { id: 'premium-1y', name: 'Premium 1Y', duration: '1 Year', durationDays: 365, price: '129.99', discount: '30', active: true, features: ['10 Devices', 'High Speed', 'Priority Support', 'Ad Blocker'] },
];
...
export function EditPlan() {
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">The plan you're looking for doesn't exist.</p>
          </div>
        </div>
      </div>
    );
  ...
  const originalPrice = parseFloat(formData.price) / (1 - parseFloat(formData.discount) / 100);
    ...
    <div className="space-y-6 max-w-4xl">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1>Edit Plan</h1>
            <p className="text-muted-foreground">Modify plan details and pricing</p>
          </div>
        </div>
              ...
              {parseFloat(formData.discount) > 0 && (
                <div className="p-4 bg-[#16A34A]/10 rounded-xl border border-[#16A34A]/20">
                  <p className="text-sm text-[#16A34A]">
                    Original Price: ${originalPrice.toFixed(2)} • You Save: ${(originalPrice - parseFloat(formData.price)).toFixed(2)} ({formData.discount}%)
                  </p>
                </div>
              )}
              ...
              <div className="flex items-center justify-between pt-4 border-t border-border">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {formData.active ? 'Plan is currently active and visible to customers' : 'Plan is inactive and hidden from customers'}
                  </p>
                </div>
                <Switch.Root
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-sm text-primary">$1,420.58</span>
              </div>
              <div className="flex justify-between">
